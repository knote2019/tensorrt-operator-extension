...
class CustomLeakyReLUPlugin : public IPluginV2DynamicExt {
 public:
    ...
    DimsExprs getOutputDimensions(int32_t outputIndex, const DimsExprs* input, int32_t nbInputs,
    ...
    bool supportsFormatCombination(int32_t pos, const PluginTensorDesc* inOuts, int32_t nbInputs,
